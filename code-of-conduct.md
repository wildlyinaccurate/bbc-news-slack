...
The BBC has a [Code of Conduct](http://www.bbc.co.uk/aboutthebbc/insidethebbc/howwework/policiesandguidelines/codeofconduct.html) and [six values](http://www.bbc.co.uk/careers/why-join-us/values) that represent the expectations we have for ourselves and each other. Our Ways of Working, described in this document, build on these. It specifically seeks to ensure that the variety of digital systems (Email, Slack, JIRA etc) we use for working together provide a welcoming, fun and productive environment for everyone.

We expect members of the BBC News community to act in a way that creates and nurtures an environment which is harassment-free, safe, comfortable, and enjoyable to be a part of, whoever you are. We do not tolerate harassment of participants in any form. Participants asked to stop any harassing behaviour are expected to comply immediately. We work hard on improving our plans, code, communications and designs - and we work just as hard on our culture. It is a work in progress, and this Ways of Working is intended to help us hold to high standards and provide a clear framework for doing that.

### Admins

As it is real time, Slack is actively administered (ie Admins aim to be online during work hours). The current admins can be found at https://bbcnews.slack.com/team. Other systems are administered retroactively. We aim to have enough admins to ensure that during work hours we are able to respond to questions about our community’s Ways of Working quickly.

New admins can be nominated by the community and need to be confirmed by Steve Wheeler and Jonathan Frost. Complaints about Admins need to be escalated to Line Managers. 


## Expected Behaviours

We strive to create a welcoming and inclusive culture, one that nurtures the positive working relationships which help us break out of silos and strictures and create better products. We want to support diversity in our teams, our thinking and ultimately in our products. We support an open exchange of ideas and we believe the following guidelines will help create spaces where everyone who is part of BBC News can feel confident that their input is valued and heard. By doing so we will help ensure we build the best products we can, and maximise the impact of our work.
...
If you witness any inappropriate behaviour, or have any other concerns, please contact the admins by sending them a direct message. They'll respond as promptly as they can.

The admins will respect confidentiality around issues. We will not name harassment victims without their affirmative consent. At our discretion, we may contact the line manager of a person about whom we’ve received harassment complaints. 

## Consequences

Participants asked to stop any inappropriate behaviour must comply immediately.

If a participant engages in inappropriate behaviour, the admins may take any action they deem appropriate, including warning the offender, expulsion from the comms channel/method and reporting the participant to their line manager.
